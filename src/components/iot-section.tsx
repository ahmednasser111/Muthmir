...
const components: IoTComponent[] = [
	...
	},
	{
		...
		description:
			"Firebase backend ensures secure, real-time data storage and synchronization across all devices.",
		icon: <Cloud className='w-6 h-6' />,
	},
	{
		title: "Processing Power",
		description:
			"Powerful microcontrollers handle complex calculations and automated decision-making processes.",
			...
			<div className='container mx-auto px-4'>
				...
				<motion.div
					...
					<p className='text-xl text-gray-600'>
						Advanced Internet of Things technology powering smart agriculture
						through real-time monitoring and automated control systems.
					</p>
				</motion.div>
				...
				<motion.div
					...
					<div className='relative rounded-2xl overflow-hidden shadow-2xl'>
						<img
							src='iot.png'
							alt='Muthmir IoT Device in Field'
						...
						<div className='absolute bottom-0 left-0 right-0 p-8 text-white'>
							...
							<p className='text-lg opacity-90 max-w-2xl'>
								Our advanced IoT sensors provide real-time environmental data
								collection and analysis for optimal crop management
							</p>
						</div>
					</div>
				</motion.div>
				...
				<motion.div
					...
					transition={{ duration: 0.6 }}
					viewport={{ once: true }}
					className='bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 text-center max-w-3xl mx-auto'>
